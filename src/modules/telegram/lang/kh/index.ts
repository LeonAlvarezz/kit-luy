...
const kh = {
  ...
  buy: {
    usage: "សូមប្រើ /buy 4.5 ឬ /buy 4.5 @userA=2 @userB=2.5",
    allocationUsage:
      "សូមប្រើការចែកដូចជា @userA=2 @userB=2.5 បន្ទាប់ពីចំនួនទឹកប្រាក់",
    ...
    allocationTotalMismatch:
      "ប្រតិបត្តិការចែកលុយត្រូវតែបូកសរុបស្មើនឹងចំនួនទឹកប្រាក់បញ្ជាទិញ",
  ...
  list: {
    ...
    fallback: "មិនអាចបង្ហាញបញ្ជីការទិញបានទេ",
  },
  void: {
  ...
  repaymentClaim: {
    ...
    fallback: "មិនអាចដំណើរការសកម្មភាពសំណើទូទាត់បានទេ",
  },
