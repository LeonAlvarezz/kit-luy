...
const kh = {
  ...
  buy: {
    usage: "សូមប្រើ /buy ដើម្បីកត់ត្រាការទិញជាជំហានៗ",
    allocationUsage:
    ...
    memberPickerCancel: "បោះបង់",
    memberPickerMyself: "ខ្ញុំ 👤",
    cancelled: "បានបោះបង់",
    everyoneSelected: "បានជ្រើសរើសគ្រប់គ្នា",
    selectAtLeastOneOther: "សូមជ្រើសរើសយ៉ាងហោចណាស់ម្នាក់ក្រៅពីខ្លួនអ្នក",
    incompleteFlow: "ដំណើរការ /buy នេះមិនទាន់ពេញលេញទេ",
    purchaseRecorded: "បានកត់ត្រាការទិញ",
    summaryHeader: "កត់ត្រាការទិញនេះ?",
    summaryTotal: "សរុប",
    summaryPaidBy: "បង់ដោយ",
  },
  paid: {
    usage: "សូមប្រើ /paid 2 ឬ /paid @userA=10",
    validAmount: "សូមផ្ញើចំនួនទឹកប្រាក់ត្រឹមត្រូវដែលធំជាង 0",
    noOtherActiveMembers: "មិនមានសមាជិកផ្សេងទៀតនៅក្នុងគ្រុបទូទាត់នេះទេ",
    askAmount: "តើអ្នកបានបង់ប៉ុន្មាន? (ឧទាហរណ៍៖ 5 ឬ 20000R ឬ 20000r)",
    ...
    summaryHeader: "បង្កើតសំណើទូទាត់?",
    summaryAmount: "ចំនួនទឹកប្រាក់",
    summaryFrom: "ពី",
    summaryTo: "ទៅ",
    summaryPurchase: "ការទិញ",
    summaryNoPurchase: "គ្មាន (ការទូទាត់ទូទៅ)",
    askPurchase: "តើការទូទាត់នេះសម្រាប់ការទិញជាក់លាក់ណាមួយមែនទេ?",
    generalPayment: "ការទូទាត់ទូទៅ / មិនមានក្នុងបញ្ជី",
    cancel: "បោះបង់",
    cancelled: "បានបោះបង់",
    incompleteFlow: "ដំណើរការ /paid នេះមិនទាន់ពេញលេញទេ",
    claimCreatedToast: "បានបង្កើតសំណើទូទាត់",
    claimCreated:
  ...
  repaymentClaim: {
    ...
    success: "#{claimId:number} ការទូទាត់ជោគជ័យ✅",
    failed: "#{claimId:number} ការទូទាត់ត្រូវបានបដិសេដ🚫",
    fallback: "មិនអាចបង្ហាញសំណើទូទាត់បានទេ",
  },
  setqr: {
    usagePrivate:
      "សូមផ្ញើ ឬបញ្ជូនបន្តរូបភាព QR សម្រាប់ទូទាត់ប្រាក់របស់អ្នកមកកាន់ប្រអប់សារផ្ទាល់នេះដើម្បីកំណត់វា។",
    useInPrivate: "សូមប្រើប្រាស់ /setqr នៅក្នុងប្រអប់សារផ្ទាល់ជាមួយ Bot។",
    success:
      "រូបភាព QR សម្រាប់ទូទាត់ប្រាក់របស់អ្នកត្រូវបានរក្សាទុកដោយជោគជ័យ! អ្នកអាចប្រើវាបាននៅក្នុងគ្រុបទូទាត់។",
    fallback: "មិនអាចរក្សាទុករូបភាព QR របស់អ្នកបានទេ។",
  },
  qr: {
    usage:
      "សូមប្រើ /qr ដើម្បីបង្ហាញ QR របស់អ្នក ឬ /qr @user ដើម្បីបង្ហាញ QR របស់សមាជិក។",
    selectMember: "សូមជ្រើសរើសសមាជិកដើម្បីមើល QR របស់គាត់៖",
    memberPickerMyself: "ខ្ញុំ 👤",
    notSetSelf:
      "អ្នកមិនទាន់បានកំណត់ QR សម្រាប់ទូទាត់ប្រាក់នៅឡើយទេ។ សូមផ្ញើសារមកខ្ញុំផ្ទាល់ និងផ្ញើរូបភាព QR របស់អ្នកដើម្បីកំណត់វា។",
    notSetOther:
      "<b>{name:string}</b> មិនទាន់បានកំណត់ QR សម្រាប់ទូទាត់ប្រាក់នៅឡើយទេ។ សូមប្រាប់គាត់អោយផ្ញើសារមកខ្ញុំផ្ទាល់ និងផ្ញើរូបភាព QR របស់គាត់។",
